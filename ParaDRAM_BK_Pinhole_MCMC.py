...
N_SAMPLES = 100000  # Total number of samples in MCMC. Includes rejected samples.
...
def main():
    ...
    pmpd.spec.chainSize = N_SAMPLES  # the default 100,000 unique points is too large for this simple example.
